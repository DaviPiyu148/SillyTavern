...
- **Social Modules & Integration**:
  ...
  - **Familiarity Decay**: 14-day exponential decay after a 7-day grace period ($\tau = 30\,\text{days}$).
...
#### 2. Future Scope Distinction (Phase 9+)
- **Phase 9 Future Scope**: Living World, Population, Environment, and Emergence (background population, environmental dynamics, rumors-in-the-wild scaling).
