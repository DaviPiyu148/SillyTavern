...
- **Dedicated Test Suites (`tests/living-world/`)**:
  - 8 dedicated Phase 11 test suites passing (78/78 tests): `lws-provenance.test.js` (16), `lws-card-importer.test.js` (10), `lws-worldinfo-importer.test.js` (9), `lws-manifest-importer.test.js` (6), `lws-ai-normalizer.test.js` (7), `lws-conflicts.test.js` (5), `lws-authoring-bundle.test.js` (7), `lws-import-api.test.js` (14).
