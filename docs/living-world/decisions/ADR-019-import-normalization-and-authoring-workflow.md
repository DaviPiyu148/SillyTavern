...
3. **Canonical LWS World Manifests (`lws_world_manifest_v1`):** Complete interchange format in JSON and secure YAML (Billion Laughs / prototype-pollution protected, `maxAliasCount: 50`, 2 MB input limit) with symmetric round-trip export/import parity.
